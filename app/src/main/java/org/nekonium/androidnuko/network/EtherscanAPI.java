package org.nekonium.androidnuko.network;
...
import org.nekonium.androidnuko.APIKey;
import org.nekonium.androidnuko.interfaces.LastIconLoaded;
import org.nekonium.androidnuko.interfaces.StorableWallet;
import org.nekonium.androidnuko.utils.Key;
import org.nekonium.androidnuko.utils.RequestCache;
import org.nekonium.androidnuko.utils.TokenIconCache;
import org.nekonium.androidnuko.utils.TxCache;
import org.nekonium.androidnuko.utils.UniqueNonceGetter;
...
public class EtherscanAPI {
     ...
     * Retrieve all internal transactions from address like contract calls, for normal transactions @see org.nekonium.androidnuko.network.EtherscanAPI#getNormalTransactions() )
     *
     * @param address Ether address
     * @param b       Network callback to @see org.nekonium.androidnuko.fragments.FragmentTransactions#update() or @see org.nekonium.androidnuko.fragments.FragmentTransactionsAll#update()
    ...
    /**
     * Retrieve all normal ether transactions from address (excluding contract calls etc, @see org.nekonium.androidnuko.network.EtherscanAPI#getInternalTransactions() )
     *
     * @param address Ether address
     * @param b       Network callback to @see org.nekonium.androidnuko.fragments.FragmentTransactions#update() or @see org.nekonium.androidnuko.fragments.FragmentTransactionsAll#update()
     * @param force   Whether to force (true) a network call or use cache (false). Only true if user uses swiperefreshlayout
     ...
     *
     * @param address Ether address
     * @param b       Network callback to @see org.nekonium.androidnuko.fragments.FragmentDetailOverview#update()
     * @param force   Whether to force (true) a network call or use cache (false). Only true if user uses swiperefreshlayout
     * @throws IOException Network exceptions
     */
     ...
     * @param callback  Callback to @see org.nekonium.androidnuko.fragments.FragmentDetailOverview#onLastIconDownloaded()
     * @throws IOException Network exceptions
     */
